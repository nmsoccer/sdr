...
#define MAX_NAME_LEN	32	//名字长度
#define MAX_DESC_LEN	64	//注释长度
#define MAX_LINE_LEN 1024	 //行长度
#define MACRO_VALUE_LEN 32	//MACRO 值长度
...
#define DEFAULT_MAX_NODE_COUNT (10*1024)	//默认NODE 数目
/*
